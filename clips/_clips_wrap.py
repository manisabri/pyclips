...
class Symbol(bytes):
    """extend a bytes for use with CLIPS as symbol"""

    def __repr__(self):
        return "<Symbol %s>" % bytes.__repr__(self)
...
class Template(object):
    ...
    def __init__(self, o=None):
        ...
        class __template_Slots:
            ...
            @_accepts_method((bytes, str))
            @_forces_method(bytes)
...
class Fact(object):
    ...
    def __init__(self, o):
        ...
        class __fact_Slots:
            ...
            @_accepts_method((bytes, str), None)
            @_forces_method(bytes, None)
    ...
    def AddMethod(self, restrictions, actions, midx=None, comment=None):
        ...
        if type(restrictions) in (tuple, list):
            ...
            for x in restrictions:
                if type(x) not in (tuple, bytes, str):
...
class Class(object):
    ...
    @_accepts_method((bytes, str), (bytes, str), None)
    @_forces_method(bytes, bytes, None)
    ...
    @_accepts_method((bytes, str), (bytes, str))
    @_forces_method(bytes, bytes)
    ...
    @_accepts_method((bytes, str), (bytes, str), (bytes, str), None, None)
    @_forces_method(bytes, bytes, bytes, None, None)
...
class Definstances(object):
    ...
    def __init__(self, o):
        ...
        if _c.isDefinstances(o):
            ...
            raise _c.ClipsError("M01: cannot directly create Definstances")
...
class Module(object):
    ...
    # Rules
    @_accepts_method((bytes, str), (bytes, str), (bytes, str), None)
    @_forces_method(bytes, bytes, bytes, None)
    ...
    def BuildGlobal(self, name, value=Nil):
        ...
        mname = self.Name
        if type(value) in (bytes, ClipsStringType):
            value = '"%s"' % value
    ...
    # Functions
    @_accepts_method((bytes, str), None, (bytes, str), None)
    @_forces_method(bytes, None, bytes, None)
    ...
    # Instances
    @_accepts_method((bytes, str), None, None)
    @_forces_method(bytes, bytes, None)
...
# {{FUNCTION
@_accepts((bytes, str), (bytes, str), None)
@_forces(bytes, bytes, None)
...
# {{FUNCTION
@_accepts((bytes, str), (bytes, str), (bytes, str), None)
@_forces(bytes, bytes, bytes, None)
...
# {{FUNCTION
@_accepts((bytes, str), None, (bytes, str), None)
@_forces(bytes, None, bytes, None)
...
# {{FUNCTION
@_accepts((bytes, str), None, None, (bytes, str), None, None)
@_forces(bytes, bytes, None, bytes, None, None)
...
# {{FUNCTION
@_accepts((bytes, str), None, (bytes, str))
@_forces(bytes, bytes, bytes)
...
def _setStockClasses():
    ...
    if __parent_module_dict__:
        ...
        __parent_module_dict__[
            'EXTERNAL_ADDRESS_CLASS'] = EXTERNAL_ADDRESS_CLASS
        __parent_module_dict__['FACT_ADDRESS_CLASS'] = FACT_ADDRESS_CLASS
        __parent_module_dict__[
            'INSTANCE_ADDRESS_CLASS'] = INSTANCE_ADDRESS_CLASS
