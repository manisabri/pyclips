...
class String(bytearray):
    ...
    def clrepr(self):
        ...
        return (_c.STRING, _bytearr(self))

    def clsyntax(self):
        """represent this String as it would be in CLIPS syntax"""
        return '"%s"' % _bytearr(self).replace("\\", "\\\\").replace('"', '\\"')
...
class Symbol(bytearray):
    ...
    def __add__(self, o):
        return Symbol(_bytearr(self) + _bytearr(o))

    def clrepr(self):
        """represent this Symbol for CLIPS"""
        return (_c.SYMBOL, _bytearr(self))
...
class InstanceName(bytearray):
    ...
    def clrepr(self):
        ...
        return (_c.INSTANCE_NAME, _bytearr(self))

    def clsyntax(self):
        """represent this InstanceName as it would be in CLIPS syntax"""
        return "[%s]" % _bytearr(self)
