...
def _nestedclass(cls):
    ...
    class NestedDescriptor(object):
        def __get__(self, outer, outercls):
            ...
            ##clsdict['__getattr__'] = lambda self, attr: getattr(outercls,
            # attr)
            def __setattr__(this, attr, value):
                # setting an attribute in the inner instance sets the
...
class Environment(object):
    ...
    def __clips_Debug(self, private_environment):
        ...
        class _clips_Debug(object):
            ...
            MessageHandlersWatched = property(
                __property_getMessageHandlersWatched,
            ...
            def __property_getGenericFunctionsWatched(self):
                return bool(
                    _c.env_getWatchItem(self.__env, "generic-functions"))

            GenericFunctionsWatched = property(
                __property_getGenericFunctionsWatched,
            ...
            ExternalTraceback = property(__property_getExternalTraceback,
                                         ...
                                         None,
                                         "traceback of Python functions in "
                                         "CLIPS")
    ...
    class Fact(object):
        ...
        Exists = property(__property_getExists,
                          None, None,
                          "determine if Fact has been asserted and not "
                          "retracted")
    ...
    class Class(object):
        ...
        def AddMessageHandler(self, name, args, text, htype=PRIMARY,
                              comment=None):
    ...
    def BuildMessageHandler(self, name, hclass, args, text, htype=PRIMARY,
                            comment=None):
