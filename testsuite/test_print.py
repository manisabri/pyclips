...
class ctc_Print(ctestcase):
    ...
    def ctf_Print_02(self):
        ...
        for x in list(self.envdict.keys()):
            ...
            self.assertTrue(i_checkContains(s, r"f1\-rule"))
    ...
    def ctf_Print_03(self):
        ...
        for x in list(self.envdict.keys()):
            ...
            self.assertTrue(i_checkContains(s, r"INITIAL\-OBJECT"))
            self.assertTrue(i_checkContains(s, r"USER"))
            self.assertTrue(i_checkContains(s, r"INSTANCE"))
            self.assertTrue(i_checkContains(s, r"ADDRESS"))
            self.assertTrue(i_checkContains(s, r"LEXEME"))
            self.assertTrue(i_checkContains(s, r"NUMBER"))
            self.assertTrue(i_checkContains(s, r"PRIMITIVE"))
            self.assertTrue(i_checkContains(s, r"OBJECT"))
            # ...
            self.assertTrue(i_checkContains(s, r"FLOAT"))
            r, s = i_returnOutput(e.PrintDeffacts)
            self.assertTrue(i_checkContains(s, r"initial\-fact"))
    ...
    def ctf_Print_04(self):
        ...
        for x in list(self.envdict.keys()):
            ...
            self.assertTrue(i_checkContains(s, r"message\-duplicate"))
            self.assertTrue(i_checkContains(s, r"direct\-duplicate"))
            self.assertTrue(i_checkContains(s, r"message\-modify"))
            self.assertTrue(i_checkContains(s, r"direct\-modify"))
            self.assertTrue(i_checkContains(s, r"print"))
            self.assertTrue(i_checkContains(s, r"create"))
    ...
    def ctf_Print_05(self):
        ...
        for x in list(self.envdict.keys()):
            ...
            self.assertTrue(i_checkContains(s, "g"))
    ...
    def ctf_Print_06(self):
        ...
        for x in list(self.envdict.keys()):
            ...
            self.assertTrue(not i_checkContains(s2, re.escape(d.PPForm())))
            self.assertTrue(i_checkContains(s3, re.escape(d.PPForm())))
            self.assertTrue(not i_checkContains(s3, re.escape(c.PPForm())))
    ...
    def ctf_Print_07(self):
        ...
        for x in list(self.envdict.keys()):
            ...
            r, s = i_returnOutput(e.PrintAgenda)
            self.assertTrue(i_checkContains(s, rex))
            r, s = i_returnOutput(e.PrintBreakpoints)
            self.assertEqual(s.strip(), "MAIN:")
            dr.Breakpoint = True
            r, s = i_returnOutput(e.PrintBreakpoints)
            self.assertTrue(i_checkContains(s, "dr"))
    ...
    def ctf_Print_10(self):
        ...
        for x in list(self.envdict.keys()):
            ...
            self.assertTrue(i_checkContains(s, r"get-s2\ .*\ class"))
            self.assertTrue(i_checkContains(s, r"put-s2\ .*\ class"))
            self.assertTrue(not i_checkContains(s, r"get-s1\ .*\ class"))
            self.assertTrue(not i_checkContains(s, r"put-s1\ .*\ class"))
    ...
    def ctf_Print_11(self):
        ...
        for x in list(self.envdict.keys()):
            ...
            self.assertTrue(i_checkContains(s, r"\>\> mh primary in class C"))
            self.assertTrue(i_checkContains(s, r"\<\< mh primary in class C"))
